  ...
  return (
      ...
      <div className="modal-importacao">
        <div className="modal-cabecalho">
          <div>
            ...
            <p>
              Informe a lista oficial. O sistema apenas altera o status do aluno
              e preserva toda a conferência documental.
            </p>
          </div>
    ...
    Não Entregue    PSICOLOGIA    aluno@gmail.com    a123@fumec.edu.br    JOÃO DA SILVA    2910130000`}
                  ...
                  <button
                    ...
                    disabled={!textoCancelados.trim() || processandoCancelados}
                  >
                    {processandoCancelados
                      ? "Analisando..."
                      : "Analisar cancelados"}
                ...
                <div className="importacao-previa">
                  ...
                  <div className="importacao-resumo resultado">
                    ...
                    <div>
                      <strong>{previaCancelados.prontos_para_cancelar}</strong>
                      <span>Prontos</span>
                    </div>
                    <div>
          ...
          {erroCancelados && <div className="modal-erro">{erroCancelados}</div>}
        </div>
