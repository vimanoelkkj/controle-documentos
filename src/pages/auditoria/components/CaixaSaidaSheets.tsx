...
export function CaixaSaidaSheets({
  ...
  return (
    <section
      className={`audit-changes-layout${temAlteracoes ? "" : " no-pending"}`}
    >
        ...
        <div className="audit-pending">
          <div className="audit-pending-head">
            <div className="audit-pending-title">
              ...
              <span
                className="audit-pending-count"
                aria-label={`${caixaSaida.total} pendências`}
              >
                {caixaSaida.total}
              </span>
            </div>
          ...
          <div className="audit-outbox-list">
            {caixaSaida.pendencias.map((item) => (
              <article key={item.id}>
                ...
                <div className="audit-outbox-author">
      ...
      <aside
        className="audit-integrity-actions"
        aria-label="Ações de integridade"
      >
        {sidebarExtra}
        <button
          className="audit-integrity-action"
          type="button"
        ...
        {admin && temAlteracoes && (
          <button
            type="button"
            className="audit-integrity-action audit-outbox-send"
          ...
          >
            <span>
              ...
              <small>
                Envie as alterações pendentes locais para a planilha.
              </small>
            </span>
          </button>
        )}
