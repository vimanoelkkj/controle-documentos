...
export default function ChangelogModal() {
  ...
  return (
    <div className="modal-overlay changelog-overlay">
      <section
      ...
      >
        <header className="changelog-modal-header">
          <div className="changelog-release-mark" aria-hidden="true">
            ✦
          </div>
          <div>
            <span>NOVIDADES DA VERSÃO</span>
            <h2 id="changelog-title">O que há de novo</h2>
            <p>
              v{CURRENT_RELEASE.version} · {CURRENT_RELEASE.date}
            </p>
          </div>
        </header>
        <div className="changelog-modal-body">
          <div className="changelog-intro">
            <strong>{CURRENT_RELEASE.title}</strong>
            <p>{CURRENT_RELEASE.description}</p>
          </div>
