...
function AppIcon({ name, size = 20, strokeWidth = 1.8 }: AppIconProps) {
  ...
  const paths: Record<AppIconName, React.ReactNode> = {
    ...
    documentRefresh: (
      <>
        <path d="M6.5 3.5h7l4 4v6.2" />
        <path d="M13.5 3.5V8h4" />
        <path d="M9 11h5M9 14h3.4" />
        <path d="M8.7 20H6.5a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1" />
        <path d="M20 16a4.6 4.6 0 0 0-7.9-2.7" />
        <path d="M12 10.8v2.9h2.9" />
        <path d="M12 17a4.6 4.6 0 0 0 7.9 2.7" />
        <path d="M20 22.2v-2.9h-2.9" />
      </>
    ),
    dashboard: (
      <>
    ...
    user: (
      <>
        ...
        <path d="M5.5 20c.5-4.2 2.7-6.5 6.5-6.5s6 2.3 6.5 6.5" />
      </>
    ),
    pie: (
      <>
    ...
    check: (
      <>
        ...
        <path d="M19 12v6a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h8" />
      </>
    ),
    mail: (
      <>
    ...
    courses: (
      <>
        ...
        <path d="M7 11v4.2c2.8 2.1 7.2 2.1 10 0V11" />
        <path d="M21 9v6" />
      </>
    ),
    settings: (
      <>
        ...
        <path
          d="M19 13.5v-3l-2-.7a7 7 0 0 0-.7-1.6l.9-1.9-2.1-2.1-1.9.9a7 7 0 0 0-1.7-.7L10.5 3h-3l-.7 2a7 7 0 0 0-1.6.7l-1.9-.9-2.1 2.1.9 1.9a7 7 0 0 0-.7 1.7L0 11.5v3l2 .7c.2.6.4 1.1.7 1.6l-.9 1.9 2.1 2.1 1.9-.9c.5.3 1 .5 1.6.7l.7 2h3l.7-2c.6-.2 1.1-.4 1.6-.7l1.9.9 2.1-2.1-.9-1.9c.3-.5.5-1 .7-1.6l1.8-.7Z"
          transform="translate(2.5 -1.5) scale(.8)"
        />
      </>
    ),
    info: (
    ...
    identity: (
      <>
        ...
        <path d="M5.5 16c.8-1.5 1.8-2.3 3-2.3s2.3.8 3 2.3M14 9h4M14 12h4M14 15h3" />
      </>
    ),
    cpf: (
      <>
    ...
    certificate: (
      <>
        <path d="M7 3.5h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-10a2 2 0 0 1 2-2Z" />
        <path d="M8.5 8h7M8.5 11h7" />
        <path d="m10 17-1 4 3-1.6 3 1.6-1-4" />
      </>
    ),
    residence: (
      <>
    ...
    education: (
      <>
        ...
        <path d="M6.5 12v4.2c3.3 2.4 7.7 2.4 11 0V12" />
        <path d="M21 9v6" />
      </>
    ),
    contract: (
    ...
    refresh: (
      <>
        <path d="M20 6v5h-5" />
        <path d="M4.8 9A7.5 7.5 0 0 1 18.5 6.5L20 11" />
        <path d="M4 18v-5h5" />
        <path d="M19.2 15A7.5 7.5 0 0 1 5.5 17.5L4 13" />
      </>
    ),
    reload: (
      <>
    ...
    edit: (
      <>
        <path d="M4 20h4l11-11a2.3 2.3 0 0 0-4-4L4 16v4Z" />
    ...
    restore: (
      <>
        <path d="M5 4.5v5h5" />
        <path d="M5.4 9.2A7.8 7.8 0 1 1 4.6 14" />
      </>
    ),
    more: (
      <>
